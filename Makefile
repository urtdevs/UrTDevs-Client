...
ifeq ($(PLATFORM),mingw32)
  ...
  ifeq ($(ARCH),x64)
    OPTIMIZEVM = -O2 -mmmx -msse -msse2 -fno-omit-frame-pointer \
      -falign-loops=2 -funroll-loops -falign-jumps=2 -falign-functions=2 \
      -fstrength-reduce
    OPTIMIZE = $(OPTIMIZEVM) --fast-math -mmmx -msse -msse2
    HAVE_VM_COMPILED = true
  endif
  ifeq ($(ARCH),x86)
    OPTIMIZEVM = -O2 -mmmx -msse -msse2 -fno-omit-frame-pointer \
      -falign-loops=2 -funroll-loops -falign-jumps=2 -falign-functions=2 \
      -fstrength-reduce
    OPTIMIZE = $(OPTIMIZEVM) -ffast-math -mmmx -msse -msse2
    HAVE_VM_COMPILED = true
  endif
...
ifeq ($(USE_SOUNDHAX),1)
	BASE_CFLAGS += -DUSE_SOUNDHAX
endif

ifeq ($(URT_4_2),1)
	BASE_CFLAGS += -DURT_4_2
endif
